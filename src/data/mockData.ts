...
export interface Patient {
  ...
  philHealthMemberName?: string;
  philHealthMemberPin?: string;
  guardianName?: string;
...
export const services: Service[] = [
  {
    ...
    description: "Doctor consultation for common illnesses",
    duration: 20,
    capacity: 60,
    icon: "Stethoscope",
    color: "primary",
  ...
  },
  {
    ...
    description: "Private counseling and family planning services",
    duration: 25,
    capacity: 30,
    icon: "Baby",
    color: "secondary",
  },
  {
    id: "s8",
    name: "Mental Health",
    description: "Confidential mental health assessment and support",
    duration: 30,
    capacity: 18,
    icon: "Brain",
    color: "accent",
  },
  {
    id: "s9",
    name: "Animal Bite",
    description: "Animal bite assessment, wound care, and vaccination referral",
    duration: 30,
    capacity: 20,
    icon: "ShieldPlus",
    color: "warning",
  ...
  },
  {
    ...
    description: "Routine childhood vaccines and immunization follow-up",
    duration: 15,
    capacity: 40,
    icon: "Syringe",
    color: "accent",
  },
  {
    id: "s4",
    name: "Dental Care",
    description: "Oral check-up, dental care, and tooth extraction",
    duration: 25,
    capacity: 20,
    icon: "Smile",
    color: "info",
  },
  {
    id: "s5",
    name: "Laboratory",
    description: "Blood, urine, and screening tests",
    duration: 20,
    capacity: 35,
    icon: "TestTube",
    color: "warning",
  },
  {
    id: "s6",
    name: "Tuberculosis",
    description: "Tuberculosis screening, treatment, and DOTS follow-up",
    duration: 15,
    capacity: 30,
    icon: "ShieldPlus",
    color: "destructive",
...
export const patients: Patient[] = [
  ...
  {
    id: "p2",
    fullName: "Juan Dela Peña",
    maskedName: "J. Dela Peña",
    dob: "1985-11-03",
    gender: "Male",
  ...
  {
    id: "p4",
    fullName: "Roberto Mariano Castillo",
    maskedName: "R. Castillo",
    dob: "1978-07-09",
    gender: "Male",
  ...
  {
    id: "p5",
    fullName: "Angelica Reyes Bautista",
    maskedName: "A. Bautista",
    dob: "1996-09-14",
    gender: "Female",
  ...
  },
  {
    ...
    maskedName: "M. Villanueva",
    dob: "1989-01-25",
    gender: "Male",
    contact: "+63 922 678 9012",
    address: "Sitio Mabini",
    barangay: "Cabaruan",
    municipality: "Jones",
    latitude: 16.5872,
    longitude: 121.7351,
  ...
  {
    id: "p8",
    fullName: "Eduardo Pineda Salazar",
    maskedName: "E. Salazar",
    dob: "1965-03-18",
    gender: "Male",
...
export const medicalRecords: MedicalRecord[] = [
  {
    ...
    notes: "No known drug allergies. Advise rest and adequate fluids.",
    prescription: [
      {
        medicineId: "m1",
        quantity: 12,
        instructions: "Take 1 tablet every 6 hours as needed for fever.",
      },
    ],
  ...
  },
  {
    ...
    notes: "Blood pressure controlled; continue maintenance medication.",
    prescription: [
      {
        medicineId: "m3",
        quantity: 30,
...
export const notifications: NotificationItem[] = [
  {
    ...
    message:
      "Your General Consultation is tomorrow. Clinic consultation hours are 8:00 AM – 5:00 PM.",
    time: "2h ago",
    read: false,
    type: "reminder",
  },
  {
    id: "n2",
    title: "Queue Update",
    message: "You are checked in. Queue A-009 is waiting for triage.",
    time: "10m ago",
    read: false,
    type: "update",
  },
  {
    ...
    message:
      "Booking reference APT-2026-0098 is confirmed. Present it when checking in.",
    time: "1d ago",
    read: true,
    type: "update",
  },
  {
    ...
    message: "Flu vaccines are now available. Walk-ins accepted Mon-Fri.",
    time: "2d ago",
    read: true,
    type: "alert",
  },
